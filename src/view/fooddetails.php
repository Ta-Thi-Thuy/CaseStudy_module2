                ...
                <div class="col-lg-6">
                    ...
                    <form method="post">
                        <table class="table table-hover table-striped table-bordered" cellspacing="0">
                            <tr>
                                <th>Tên thực phẩm</th>
                                <td><input type="text" name="food" value="<?php
                                    echo $showDetails[0]['foodName'] ?>"></td>
                            ...
                            <tr>
                                <th>Mô tả</th>
                                <td>
                                    <textarea cols="30" rows="15" type="text" name="desc"><?php echo $showDetails[0]['foodDescriptions'] ?></textarea>
                                </td>
